...
int PARAMETER-FUNCTIONNAME()
{
	...
	filename=filename+"PARAMETER-FILEINDENTIFIER";
	...
	double lambda=PARAMETER-CALIBRATIONFACTOR;
	...
	double mom0=PARAMETER-MOMENTUMMEAN;           // in GeV
        double mom_slope=PARAMETER-MOMENTUMSLOPE;    // in GeV/mm
