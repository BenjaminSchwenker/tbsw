...
mytuple->SetBranchAddress("sizeU",&_sizeU);
mytuple->SetBranchAddress("sizeV",&_sizeV);
...
for(int i=0; i< mytuple->GetEntries(); i++){
    ...
    if (  _hasTrack == 0 && _chi2 < CHI2MAX ){
      ...
      histo_cc[binx][biny]->Fill(_sizeU);
      histo_rr[binx][biny]->Fill(_sizeV);

      

      // Fill 1d histos
      histo_c[binx]->Fill(_sizeU);
      histo_r[biny]->Fill(_sizeV);
...
h2ccm->GetZaxis()->SetTitle("Mean u size");
...
h2rrm->GetZaxis()->SetTitle("Mean v size");
...
h2ccrms->SetTitle("");
h2ccrms->GetXaxis()->SetTitle("u [#mum]");
h2ccrms->GetYaxis()->SetTitle("v [#mum]");
h2ccrms->GetZaxis()->SetTitle("Variance of u size");
...
h2rrrms->SetTitle("");
h2rrrms->GetXaxis()->SetTitle("u [#mum]");
h2rrrms->GetYaxis()->SetTitle("v [#mum]");
h2rrrms->GetZaxis()->SetTitle("Variance of v size");
...
hmean_c->GetYaxis()->SetTitle("Mean u size");
...
hvar_c->SetTitle("");
hvar_c->GetXaxis()->SetTitle("u [#mum]");
hvar_c->GetYaxis()->SetTitle("Variance of u size");
...
hmean_r->GetYaxis()->SetTitle("Mean v size");
...
hvar_r->SetTitle("");
hvar_r->GetXaxis()->SetTitle("v [#mum]");
hvar_r->GetYaxis()->SetTitle("Variance of v size");
