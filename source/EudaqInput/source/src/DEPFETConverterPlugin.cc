...
class DEPFETConverterPlugin : public DataConverterPlugin, public DEPFETConverterBase {
 public:
  ...
  virtual void GetLCIORunHeader(lcio::LCRunHeader & header, eudaqinput::Event const & bore) const {
...
void DEPFETConverterBase::ConvertLCIOHeader(lcio::LCRunHeader & header, eudaqinput::Event const & /*bore*/) const {}
