#ifndef EUDAQINPUT_INCLUDED_RawDataEvent
#define EUDAQINPUT_INCLUDED_RawDataEvent
...
namespace eudaqinput {
  ...
  class RawDataEvent : public Event {
    EUDAQINPUT_DECLARE_EVENT(RawDataEvent);
  public:
...
#endif // EUDAQINPUT_INCLUDED_RawDataEvent
