#ifndef EUDAQINPUT_INCLUDED_DataConverterPlugin
#define EUDAQINPUT_INCLUDED_DataConverterPlugin
 ...
 *  actual impementation provides the GetLCIOEvent() functions which
 *  get the eudaqinput::Event as input parameter.
 *
 ...
 */
  ...
  public:
    ...
    virtual void Initialize(eudaqinput::Event const &) {}

    virtual unsigned GetTriggerID(eudaqinput::Event const &) const;

    virtual void GetLCIORunHeader(lcio::LCRunHeader &, eudaqinput::Event const &) const {}

    /** Returns the LCIO version of the event.
     */
    virtual bool GetLCIOSubEvent(lcio::LCEvent & /*result*/, eudaqinput::Event const & /*source*/) const { return false; }
...
#endif // EUDAQINPUT_INCLUDED_DataConverterPlugin
